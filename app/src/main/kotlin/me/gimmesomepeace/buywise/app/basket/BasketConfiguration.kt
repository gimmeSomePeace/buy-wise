...
class BasketConfiguration {
    @Bean
    fun basketRepository(basketJpaRepository: BasketJpaRepository): BasketRepository =
        BasketRepositoryImpl(basketJpaRepository)
    ...
    @Bean
    fun changeBasketItemQuantityUseCase(repository: BasketRepository) =
